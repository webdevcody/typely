  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Add content that will help train your AI assistant. Be specific and
          detailed in your content for better results.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Give your content a clear, descriptive title for easy
                    reference.
                  </FormDescription>
                  <FormControl>
                    <Input
